define(function (require) {
  ...
  class NPCHandlers {
    constructor() {
      this.handlers = {
        SAY_DIALOG: this.onMessage.bind(this),
        WAIT_DIALOG: this.onNextAppear.bind(this),
        CLOSE_DIALOG: this.onCloseAppear.bind(this),
        OPEN_EDITDLG: this.onInputAppear.bind(this),
        OPEN_EDITDLGSTR: this.onInputAppear.bind(this),
        MENU_LIST: this.onMenuAppear.bind(this),
        SELECT_DEALTYPE: this.onDealSelection.bind(this),
        SHOW_IMAGE: this.onCutin.bind(this),
        SHOW_IMAGE2: this.onCutin.bind(this),
        COMPASS: this.onMinimapMarker.bind(this),
        PROGRESS: this.onProgressBar.bind(this),
        PROGRESS_CANCEL: this.onProgressBarStop.bind(this),
        SOUND: this.onSound.bind(this),
        PLAY_NPC_BGM: this.onBGM.bind(this),
        CLOSE_SCRIPT: this.onCloseScript.bind(this)
      };
